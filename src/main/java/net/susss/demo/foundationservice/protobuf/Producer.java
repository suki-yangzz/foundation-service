...
public class Producer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            addressBook.mergeFrom(new FileInputStream("addressbook.data"));
        ...
        // Add an address.
        addressBook.addPeople(Person.newBuilder()
                                    .setId(1234)
                                    .setName("John Doe")
        ...
        FileOutputStream output = new FileOutputStream("addressbook.data");
